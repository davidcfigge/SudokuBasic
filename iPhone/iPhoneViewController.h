...
@interface iPhoneViewController : UIViewController <ViewProtocol,DCFImgViewProtocol,PopupController,iPhoneHelpProtocol> {
	...
	iPhonePopupWindowController* ippwc;	// iPhonePopupControllerWindow (nil if not active)
	...
	CmdButton* soundButton;			// Sound icon
