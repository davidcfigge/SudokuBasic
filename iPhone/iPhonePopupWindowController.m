    //
//  iPhonePopupWindowCOntroller.m
//  Sudoku Basic
//
//  Created by David Figge on 1/13/11.
//  Copyright 2011 __MyCompanyName__. All rights reserved.
//

#import "iPhonePopupWindowCOntroller.h"


@implementation iPhonePopupWindowController
...
-(id)initWithTitle:(NSString*)title withFrame:(CGRect)frm withPCDelegate:(id<PopupController>)del withID:(int)Id {
	...
	if (!self) return self;
	theView = [[DCFPopupView alloc] initWithTitle:title withBaseImage:@"phBoardBase.png" withFrame:frm withDelegate:self withID:Id];	// Create the window
